      	...
      	success:function(respuesta){
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<input type="text" class="form-control nuevoNombreProducto" idProducto="'+idProducto+'" name="agregarProducto" value="'+nombre+'" readonly required>'+
...
function listarProductos(){
	...
	for(var i = 0; i < nombre.length; i++){
		...
		listaProductos.push({ "id" : $(nombre[i]).attr("idProducto"), 
							  "nombre" : $(nombre[i]).val(),
