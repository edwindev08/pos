        ...
        <div class="form-group">
         ...
         <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="newBird" id="newBird"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarBird" id="editarBird"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required>
